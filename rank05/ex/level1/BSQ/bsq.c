...
int loadMap(FILE* file, t_map* map, t_el* elements)
{
...
void find_big_square(t_map* map, t_square* square, t_el* hlements)
{
	// matrix init
...
void print_filled_square(t_map* map, t_square* square, t_el* elements)
{
